    ...
    public class RecordingsChannel : IChannel, IHasCacheKey, ISupportsDelete, ISupportsLatestMedia, ISupportsMediaProbe, IHasFolderAttributes
    {
        ...
        public Task<DynamicImageResponse> GetChannelImage(ImageType type, CancellationToken cancellationToken)
        {
            if (type == ImageType.Primary)
            {
                ...
                {
                    Path = "http://tvdr.de/vdr-logo.jpg",
        ...
        private ChannelItemInfo ConvertToChannelItem(MyRecordingInfo item)
        {
            ...
            var baseUrl = Plugin.Instance.Configuration.VDR_HttpStream_BaseUrl;
            //http://localhost:3000/TS/2053:6685266.rec
            var streamUrl = string.Format("{0}/recordings/{1}.rec", baseUrl, item.Inode);            
